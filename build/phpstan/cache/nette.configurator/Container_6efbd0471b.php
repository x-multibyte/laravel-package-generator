...
class Container_6efbd0471b extends _PHPStan_b22655c3f\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_6efbd0471b $container)
			{
	...
	public function createServiceContainer(): Container_6efbd0471b
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'generateBaselineFile' => '/Users/roy/Documents/trae_projects/laravel-package-builder/packages/trae/laravel-package-generator/phpstan-baseline.neon',
			'usedLevel' => '9',
